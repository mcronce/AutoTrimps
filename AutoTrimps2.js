var ATversion='Zek v4.0.0',atscript=document.getElementById('AutoTrimps-script'),basepath='https://mcronce.github.io/AutoTrimps/',modulepath='modules/';null!==atscript&&(basepath=atscript.src.replace(/AutoTrimps2\.js$/,''));
