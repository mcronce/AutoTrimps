...
function calcEnemyHealth(world, map) {
    ...
    if(world) {
        health = calcEnemyBaseHealth(world, 50, 'Snimp');
    } else {
        ...
        health = calcEnemyBaseHealth(game.global.world, level, worst_imp);
    }
    ...
    if(map) {
        ...
        corrupt = (world >= mutations.Corrupt.start());
        healthy = (world > 300);
    } else {
        corrupt = mutations.Corruption.active();
        healthy = mutations.Healthy.active();
    }
