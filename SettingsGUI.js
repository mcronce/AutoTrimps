...
function initializeAllSettings() {
    ...
    createSetting('DynamicNursery', 'Dynamic Nurseries', 'Only build nurseries when your Trimps die before the breed timer is up', 'boolean', false, null, 'Buildings');
    ...
    //Line 1
    createSetting('BetterAutoFight', ['Better AutoFight OFF', 'Better Auto Fight 1', 'Better Auto Fight 2', 'Vanilla'], '4-Way Button, Recommended. Will automatically handle fighting.<br>BAF = Old Algo (Fights if dead, new squad ready, new squad breed timer target exceeded, and if breeding takes under 0.5 seconds<br>BAF3 = Uses vanilla autofight and makes sure you fight on portal. <br> WARNING: If you autoportal with BetterAutoFight disabled, the game may sit there doing nothing until you click FIGHT. (not good for afk) ', 'multitoggle', 4, null, "Combat");
    ...
    createSetting('ScryerUseinMaps2', ['Maps: NEVER', 'Maps: FORCE', 'Maps: MAYBE', 'Maps: MAYBE (Overkill)'], '<b>NEVER</b> Means what it says!!!<br><b>FORCE</b> means Scryer will ALWAYS activate in Maps<br><b>MAYBE</b> means that Overkill and Min/Max use are allowed.<br>This setting requires use on Corrupteds to be on after corruption/magma.<br><br>Recommend MAYBE (Overkill).', 'multitoggle', 3, null, 'Scryer');
    ...
    createSetting('scry_cheat', 'Cheat when scrying', 'Only scry in the world when one of the cells you might beat this or next round is holding Dark Essence', 'boolean', false, null, 'Scryer');
